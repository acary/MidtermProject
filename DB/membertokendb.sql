...
CREATE TABLE IF NOT EXISTS `member_token` (
  ...
  `description` TEXT NULL,
  `original` TINYINT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
...
START TRANSACTION;
USE `membertokendb`;
INSERT INTO `user` (`id`, `email`, `first_name`, `last_name`, `username`, `password`, `active`, `role`, `profile_image_url`, `about_me`) VALUES (1, 'nikefan@gmail.com', 'James', 'Toney', 'nikefan', 'nikefan', 1, 'user', 'https://upload.wikimedia.org/wikipedia/commons/6/64/James_Toney.jpg', 'Former professional boxer, current coach and sportswear enthusiast.');
...
INSERT INTO `user` (`id`, `email`, `first_name`, `last_name`, `username`, `password`, `active`, `role`, `profile_image_url`, `about_me`) VALUES (5, 'iwcfan@gmail.com', 'Sarah', 'Miller', 'iwcfan', 'iwcfan', 1, 'user', 'https://www.csueastbay.edu/directory/profiles/files/images/sw/sarah-taylor.jpg', 'Professional web developer with a passion for cars and fashion. ');
...
START TRANSACTION;
USE `membertokendb`;
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (1, 'Air Jordan 1 Stash', 'https://secure-images.nike.com/is/image/DotCom/DN4336_001_A_PREM', 1000, 100, '2022-05-03', 1, 1, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (2, 'Mexican Pizza', 'https://images.unsplash.com/photo-1596109212150-dd447ec78b41', 1100, 100, '2022-05-19', 2, 2, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (3, 'Superstar Parley', 'https://assets.adidas.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/59a9d67b4de1483190cbadf90089b3f8_9366/Superstar_Parley_Shoes_White_GV7615_01_standard.jpg', 1000, 100, '2022-05-20', 3, 3, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (4, 'Le Casa De Papel Classic', 'https://assets.reebok.com/images/h_840,f_auto,q_auto,fl_lossy,c_fill,g_auto/87b6dbb89bab419183eaae550066a68d_9366/La_Casa_De_Papel_Classic_Leather_Shoes_White_GX9443_01_standard.jpg', 1000, 100, '2022-05-03', 4, 4, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (5, 'Pickle Fries', 'https://assets3.thrillist.com/v1/image/3075306/1584x1054/crop;webp=auto;jpeg_quality=60.jpg', 1000, 100, '2022-03-01', 5, 5, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (6, 'Planet Ocean 6000M', 'https://k8q7r7a2.stackpathcdn.com/wp-content/uploads/2022/03/Omega-Seamaster-Planet-Ocean-Ultra-Deep-6000m-O-Megasteel-review-2.jpg', 1800, 100, '2022-04-29', 6, 6, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (7, 'Chronograph 41 TOP GUN Ceratanium', 'https://k8q7r7a2.stackpathcdn.com/wp-content/uploads/2022/03/IWC-Pilots-Watch-Chronograph-41-TOP-GUN-Ceratanium-IW388106-hands-on-watches-and-wonders-2022-1.jpg', 1200, 100, '2022-05-03', 7, 7, NULL, 1);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`, `original`) VALUES (8, 'Khaki Field Titanium Automatic', 'https://hodinkee.imgix.net/uploads/images/16f730fa-b296-4ae3-8711-3dad9dc6f6c2/Hamiltons_SH9_5659_toned.jpg?ixlib=rails-1.1.0&fm=jpg&q=55&auto=format&usm=12&fit=crop&ch=Width%2CDPR%2CSave-Data&alt=&w=1640', 1000, 100, '2022-05-03', 8, 8, NULL, 1);
