...
INSERT INTO `business` (`id`, `description`, `name`, `user_id`, `logo_image_url`) VALUES (5, 'SONIC®, America’s Drive-In®, is part of the Inspire Brands family of restaurants. Inspire is a multi-brand restaurant company whose portfolio includes more than 8,300 Arby’s, Buffalo Wild Wings, and SONIC locations worldwide.', 'Sonic', 1, 'https://download.logo.wine/logo/Sonic_Drive-In/Sonic_Drive-In-Logo.wine.png');
INSERT INTO `business` (`id`, `description`, `name`, `user_id`, `logo_image_url`) VALUES (6, 'Founded in 1848, OMEGA is a watch brand synonymous with excellence, innovation and precision. The company has constantly been defined by its pioneering spirit, demonstrated by its conquests of the oceans as well as space.', 'Omega', 1, 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Omega_Logo.svg/1200px-Omega_Logo.svg.png');
INSERT INTO `business` (`id`, `description`, `name`, `user_id`, `logo_image_url`) VALUES (7, 'An American watchmaking pioneer named Florentine Ariosto Jones founded the International Watch Company in Schaffhausen in 1868. He drew on the help of eminently qualified Swiss watchmakers, modern technology and hydropower sourced from the nearby River Rhine to manufacture watch movements of the highest possible quality', 'IWC', 1, 'https://upload.wikimedia.org/wikipedia/commons/d/dc/IWC_Schaffhausen_Logo.jpg');
INSERT INTO `business` (`id`, `description`, `name`, `user_id`, `logo_image_url`) VALUES (8, 'Pioneering, practical, precise: Hamilton uses a unique combination of Swiss precision and American spirit to create distinctive, versatile watches for aficionados and style conscious individuals alike. Hamilton has a long history and has achieved numerous milestones, all of which have contributed to making Hamilton the strong, internationally renowned watch brand it is today.', 'Hamilton', 1, 'https://vectorlogoseek.com/wp-content/uploads/2020/05/hamilton-watch-vector-logo.png');
...
INSERT INTO `actual_item` (`id`, `name`, `description`, `image_url`) VALUES (5, 'Pickle Fries', NULL, NULL);
INSERT INTO `actual_item` (`id`, `name`, `description`, `image_url`) VALUES (6, 'Planet Ocean 6000M', NULL, NULL);
INSERT INTO `actual_item` (`id`, `name`, `description`, `image_url`) VALUES (7, 'Chronograph 41 Top Gun Ceratanium', NULL, NULL);
INSERT INTO `actual_item` (`id`, `name`, `description`, `image_url`) VALUES (8, 'Khaki Field Titanium Automatic', NULL, NULL);
...
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`) VALUES (2, 'Mexican Pizza', 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.today.com%2Ffood%2Frestaurants%2Fmexican-pizza-taco-bell-returning-rcna24652&psig=AOvVaw3ukNTVite-nuHVxXM0mW7_&ust=1650744860801000&source=images&cd=vfe&ved=0CAwQjRxqFwoTCJjWs_y9qPcCFQAAAAAdAAAAABAD', 1100, 100, '2022-05-19', 1, 1, NULL);
...
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`) VALUES (5, 'Pickle Fries', 'https://assets3.thrillist.com/v1/image/3075306/1584x1054/crop;webp=auto;jpeg_quality=60.jpg', 1000, 100, '2022-03-01', 1, 1, NULL);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`) VALUES (6, 'Planet Ocean 6000M', 'https://k8q7r7a2.stackpathcdn.com/wp-content/uploads/2022/03/Omega-Seamaster-Planet-Ocean-Ultra-Deep-6000m-O-Megasteel-review-2.jpg', 1800, 100, '2022-04-29', 1, 1, NULL);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`) VALUES (7, 'Chronograph 41 TOP GUN Ceratanium', 'https://k8q7r7a2.stackpathcdn.com/wp-content/uploads/2022/03/IWC-Pilots-Watch-Chronograph-41-TOP-GUN-Ceratanium-IW388106-hands-on-watches-and-wonders-2022-1.jpg', 1200, 100, '2022-05-03', 1, 1, NULL);
INSERT INTO `member_token` (`id`, `token_name`, `token_img_url`, `price`, `total_supply`, `release_date`, `collection_id`, `actual_item_id`, `description`) VALUES (8, 'Khaki Field Titanium Automatic', 'https://hodinkee.imgix.net/uploads/images/16f730fa-b296-4ae3-8711-3dad9dc6f6c2/Hamiltons_SH9_5659_toned.jpg?ixlib=rails-1.1.0&fm=jpg&q=55&auto=format&usm=12&fit=crop&ch=Width%2CDPR%2CSave-Data&alt=&w=1640', 1000, 100, '200-05-03', 1, 1, NULL);
...
INSERT INTO `content_resource` (`id`, `content_id`, `resource_url`, `title`, `description`) VALUES (5, 5, 'https://www.thrillist.com/news/nation/sonic-big-dill-cheeseburger-pickle-fries', 'Availbale 3/2 at 7 AM', 'A Pickle-Lover\'s Dream!');
INSERT INTO `content_resource` (`id`, `content_id`, `resource_url`, `title`, `description`) VALUES (6, 6, 'https://www.omegawatches.com/en-us/omegadays/seamaster-planet-ocean-ultra-deep', 'Available 6/29 at 6:00 AM', 'After reaching the deepest place on Earth in 2019, the ground-breaking Ultra Deep watch has been repurposed into a new 45.5 mm collection available to the public. Tested in real ocean conditions, this incredible divers’ range is water-resistant to 6,000 metres (20,000 ft.) and certified to meet the ISO 6425 standard.');
INSERT INTO `content_resource` (`id`, `content_id`, `resource_url`, `title`, `description`) VALUES (7, 7, 'https://www.watchtime.com/wristwatch-industry-news/iwc-is-back-in-black-with-the-chronograph-41-top-gun-ceratanium/', '6/1 at 1:00', 'The TOP GUN watches, which IWC has been producing since 2007, take their name from the Strike Fighter Tactics Instructor Program in the U.S. Navy. This training programme provides the best Navy pilots with flying and tactical training. The TOP GUN watches are therefore specially designed with robust materials, such as ceramic, titanium and for the first time Ceratanium®, an innovative material developed by IWC, to meet the specific requirements of elite jet pilots.');
INSERT INTO `content_resource` (`id`, `content_id`, `resource_url`, `title`, `description`) VALUES (8, 8, 'https://hiconsumption.com/hamilton-khaki-field-titanium-38/', '5/10', 'Are you looking for the ideal military watch? The Khaki Field collection includes classic army style watches that have been tried and tested over time. Rugged, robust and resilient, they’re ready for the outdoors and can compete with the best sport watches out there. Built for life’s adventurers, they’re guaranteed to be equal to your needs out in the field');
